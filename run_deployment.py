...
def run_deployment(config:str,min_accuracy:float):
    ...
    if deploy:
        continuous_deployment_pipeline(data_path=r"/mnt/c/Users/hs414/OneDrive/Desktop/test/MLOPS_MAJOR/data/data_encoded_main.csv",min_accuracy=min_accuracy,workers=3,timeout=60)
    if predict:
        inference_pipeline(
